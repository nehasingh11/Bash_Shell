...
#You are given a file with four space separated columns containing the scores of students 
#in three subjects. The first column contains a single character (A-Z), the student identifier. 
